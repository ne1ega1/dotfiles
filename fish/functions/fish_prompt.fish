function fish_prompt
	...
	__sf_util_set_default SPACEFISH_PROMPT_ORDER time user dir host git package node ruby golang php rust haskell julia elixir docker aws venv conda dotnet kubecontext exec_time line_sep battery vi_mode jobs exit_code char
